            ...
            <main class="">
                <div class="grid mb-4 pb-10 px-8 mx-4 rounded-3xl bg-gray-100 border-4 border-green-400">
                    <div class="flex justify-between items-end">
                        <div>
                            <h1 class="mt-5 mx-5 text-xl">Lista de Alumnos</h1>
                        </div>
                        <div>
                            <form action="/alumnos/create">
                            ...
                            <div class='col-span-12 mt-5'>
                                <div class="grid gap-2 grid-cols-1 lg:grid-cols-1">
                                    <div class="bg-white p-4 shadow-lg rounded-lg">
                                        <h2 class="font-bold text-base">Información de Alumnos</h2>
                                        <div class="mt-4">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="px-6 py-3 whitespace-no-wrap text-sm leading-5">
                                                                                <div class="flex space-x-4" id="open-btn">
                                                                                    <!-- href="/permisos/edit?id=<?= $alumno["id"] ?>" -->
                                                                                    <a class="text-blue-500 hover:text-blue-600" href="/alumnos/edit?id=<?= $alumno["id"] ?>">
                                                                                    ...
                                                                                    <form action="/alumnos/delete" method="post" style="display: inline;">
                                                                                        ...
                                                                                        <a href="/alumnos/delete?id=<?= $alumno["id"] ?>" class="text-red-500 hover:text-red-600">
        ...
        <div class="sidebar">
            <div class="flex justify-center">
                <div class="">
                    ...
                    <p class="font-bold text-base  text-gray-400 pt-2 text-center w-24"><?= $rol ?></p>
                </div>
            </div>
            ...
            <ul class="side-bar-side">
                ...
                <li class="side-bar-inside">
                    ...
                    <a href="/permisos">Permisos de Seguridad</a>
                </li>
                <li class="side-bar-inside">
